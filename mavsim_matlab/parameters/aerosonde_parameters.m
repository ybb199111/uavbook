...
MAV.eul        = [MAV.phi0  MAV.theta0  MAV.psi0];%注意对应的是“ZYX”的顺序，
MAV.e          = eul2quat(MAV.eul); %欧拉角向四元数转换 现在转换四元数使用的是“eul2quat”函数，顺序是ZYX。注意单位是rad
MAV.e0     = MAV.e(1);  % initial quaternion
MAV.e1     = MAV.e(2);
MAV.e2     = MAV.e(3);
MAV.e3     = MAV.e(4);
